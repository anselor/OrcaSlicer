...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "single_extruder_multi_material", "manual_filament_change", "filament_mapping_protocol", "enable_manual_filament_swap", "file_start_gcode", "machine_start_gcode", "machine_end_gcode", "before_layer_change_gcode", "printing_by_object_gcode", "layer_change_gcode", "time_lapse_gcode", "wrapping_detection_gcode", "change_filament_gcode", "filament_swap_gcode", "change_extrusion_role_gcode",
